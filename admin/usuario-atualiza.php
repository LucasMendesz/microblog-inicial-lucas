...
// Verificando quando 0 botão for acionado
if(isset($_POST['atualizar']) ) {
	...
	/* Algoritmo da Senha
	Se o campo do formulário estiver vazio, significa que o usuário NÃO MUDOU A SENHA.*/
	if(empty($_POST['senha']) ) {
		$usuario->setSenha( $dados['senha']);
	} else {
		/* Caso contrário, se o usuário digitou coisa no campo senha, precisaremos verificar o que foi digitado */
		 $usuario->setSenha( 
