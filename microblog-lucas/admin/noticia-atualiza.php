...
if (isset($_POST['atualizar'])) {
    ...
    // Utilitarios::dump($_FILES['imagem']);
    // die();
    ...
    /* Senão, pegamos a referência (nome e extensão) da nova imagem e fazemos o processo de upload e envio desta referência para o objeto(usando o setter) */
        ...
        <form class="mx-auto w-75" action="" method="post" id="form-atualizar" name="form-atualizar" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <p>Deixar a notícia em destaque?
                    <input type="radio" class="btn-check" name="destaque" id="nao" autocomplete="off" <?php if($dados['destaque'] === 'nao') echo " checked " ?> value="nao">
                    <label class="btn btn-outline-danger" for="nao">Não</label>

                    <input type="radio" class="btn-check" name="destaque" id="sim" autocomplete="off" <?php if($dados['destaque'] === 'sim') echo " checked " ?> value="sim">
